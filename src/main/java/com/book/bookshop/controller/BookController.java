...
public class BookController {
    ...
    public String searchBookLIst(String name, Model model){
        model.addAttribute("name",name);
        return "booksList_search";
    }

    @RequestMapping("/searchBookListData")
    public String searchBookListData(String name,Integer page, Integer pageSize,Model model){
        QueryWrapper<Book> queryWrapper = new QueryWrapper<>();
